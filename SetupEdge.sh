...
curl  -L https://github.com/Azure/azure-iotedge/releases/download/1.0.9.1/libiothsm-std_1.0.9.1-1-1_debian9_armhf.deb -o libiothsm-std.deb
curl  -L https://github.com/Azure/azure-iotedge/releases/download/1.0.9.1/iotedge_1.0.9.1-1_debian9_armhf.deb -o iotedge.deb
